...
parser.add_argument('-robot_name',
                    type=str,
                    default='FE_panda_with_block_pybul',
                    help='name of the simulated robot')

parser.add_argument('-robot_urdf',
                    type=str,
                    default='./FE_panda/models/panda_arm_with_block.urdf',
...
num_joints = pybullet.getNumJoints(pandaId) -1
...
ll = [-2.9, -1.8, -2.9, -3.0, -2.9, 0.0, -2.9] #[rad] -- last value is for joint 8 which is fixed
ul = [2.9, 1.8, 2.9, 0.0, 2.9, 3.8, 2.9] #[rad] -- last value is for joint 8 which is fixed
